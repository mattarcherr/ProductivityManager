...
QT_MOC_LITERAL(49, 8), // "readTask"
QT_MOC_LITERAL(58, 3), // "pos"
QT_MOC_LITERAL(62, 7), // "addTask"
QT_MOC_LITERAL(70, 4), // "data"
QT_MOC_LITERAL(75, 10), // "deleteTask"
QT_MOC_LITERAL(86, 6), // "exists"
QT_MOC_LITERAL(93, 4) // "size"

    },
    "FileIO\0sourceChanged\0\0source\0error\0"
    "msg\0setSource\0readTask\0pos\0addTask\0"
    "data\0deleteTask\0exists\0size"
};
...
static const uint qt_meta_data_FileIO[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       7,    1,   71,    2, 0x02,    8 /* Public */,
       9,    1,   74,    2, 0x02,   10 /* Public */,
      11,    1,   77,    2, 0x02,   12 /* Public */,
      12,    0,   80,    2, 0x02,   14 /* Public */,
      13,    0,   81,    2, 0x02,   15 /* Public */,
...
void FileIO::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: { QJsonObject _r = _t->readTask((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])));
            if (_a[0]) *reinterpret_cast< QJsonObject*>(_a[0]) = std::move(_r); }  break;
        case 4: { bool _r = _t->addTask((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 5: { bool _r = _t->deleteTask((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 6: { bool _r = _t->exists();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
